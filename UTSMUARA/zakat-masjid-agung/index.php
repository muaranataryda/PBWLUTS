...
<html>
<head>
    <title>Pembayaran Zakat Mesjid Agung Kota Sibolga</title>
      ...
      <div id="page-content-wrapper">
        ...
        <div class="page-content inset">
          <div class="jumbotron" style="margin: 20px 20px 20px 20px; padding: 20px 20px 20px 20px">
              ...
              UTS Pemrograman Web Lanjutan Si-4
              </h2>
              <h3 class="text-center">
              Sistem untuk mendata pembayaran Zakat  Mesjid Agung Kota Sibolga
              </h3>
              <br>
              <p>
                Muara Nataryda Lubis <br>
                  <ul>
                    <li>0702191123</li>
